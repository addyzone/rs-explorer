    ...
    styles: [
      {
        ...
        // Matches wiki3d's sizeMul so label text reads the same size on
        // both styles; haloMul is left at the default since original's
        // flatter background doesn't need wiki3d's heavier halo.
        labelStyle: { sizeMul: 1.15 },
      },
      {
        id: "wiki3d",
        label: "RS Wiki 3D",
...
export const LABEL_TIERS = {
  ...
  major:    { label: "Major",    color: "#f6f2e8", font: 17,   weight: 700, tracking: 0.2, minScale: 0,    maxScale: Infinity,  searchZoom: 0.5,  sizeSteps: [[0.25, 12], [0.5, 17], [1, 17], [2, 19], [5, 20], [6, 20.75], [7, 22.25], [8, 23.5]] },
  minor:    { label: "Minor",    color: "#e6ddca", font: 12.5, weight: 600, tracking: 0.1, minScale: 0.28, maxScale: Infinity,  searchZoom: 0.5,  sizeSteps: [[0.28, 12.5], [1, 12.5], [2, 14], [5, 15], [6, 15.75], [7, 17.25], [8, 18.5]] },
  landmark: { label: "Landmark", color: "#c9d3dd", font: 11,   weight: 500, tracking: 0,   minScale: 0.52, maxScale: Infinity,  searchZoom: 1,    sizeSteps: [[0.52, 11], [1, 11], [2, 12.5], [5, 13.5], [6, 14.25], [7, 15.75], [8, 17] ] },
  feature:  { label: "Feature",  color: "#9aa2ab", font: 9,    weight: 500, tracking: 0,   minScale: 0.85, maxScale: Infinity,  searchZoom: 1,    sizeSteps: [[0.85, 9], [1, 9], [2, 10.5], [5, 11.5], [6, 12.25], [7, 13.75], [8, 15] ] },
  npc:      { label: "NPC",      color: "#7fa8cf", font: 9,    weight: 500, tracking: 0,   minScale: 0.85, maxScale: Infinity,  searchZoom: 1,    sizeSteps: [[0.85, 9], [1, 9], [2, 10.5], [5, 11.5], [6, 12.25], [7, 13.75], [8, 15] ] },
  monster:  { label: "Monster",  color: "#cf9868", font: 9,    weight: 500, tracking: 0,   minScale: 0.85, maxScale: Infinity,  searchZoom: 1,    sizeSteps: [[0.85, 9], [1, 9], [2, 10.5], [5, 11.5], [6, 12.25], [7, 13.75], [8, 15] ] },
  detail:   { label: "Detail",   color: "#9aa2ab", font: 7.5,  weight: 500, tracking: 0,   minScale: 2,    maxScale: Infinity,  searchZoom: 2.5,  fadeBand: 2, sizeSteps: [[1, 7.5], [2, 8.5], [5, 9.5], [6, 10.25], [7, 11.75], [8, 13]] },
};
