...
export const LABEL_TIERS = {
  ...
  major:    { label: "Major",    color: "#f6f2e8", font: 17,   weight: 700, tracking: 0.2, minScale: 0,    maxScale: Infinity,  searchZoom: 0.5,  sizeSteps: [[0.25, 12], [0.5, 17], [1, 17], [2, 19], [5, 20], [6, 20.5], [7, 21], [8, 21.5]] },
  minor:    { label: "Minor",    color: "#e6ddca", font: 12.5, weight: 600, tracking: 0.1, minScale: 0.28, maxScale: Infinity,  searchZoom: 0.5,  sizeSteps: [[0.28, 12.5], [1, 12.5], [2, 14], [5, 15], [6, 15.5], [7, 16], [8, 16.5]] },
  landmark: { label: "Landmark", color: "#c9d3dd", font: 11,   weight: 500, tracking: 0,   minScale: 0.52, maxScale: Infinity,  searchZoom: 1,    sizeSteps: [[0.52, 11], [1, 11], [2, 12.5], [5, 13.5], [6, 14], [7, 14.5], [8, 15]] },
  feature:  { label: "Feature",  color: "#9aa2ab", font: 9,    weight: 500, tracking: 0,   minScale: 0.85, maxScale: Infinity,  searchZoom: 1,    sizeSteps: [[0.85, 9], [1, 9], [2, 10.5], [5, 11.5], [6, 12], [7, 12.5], [8, 13]] },
  npc:      { label: "NPC",      color: "#7fa8cf", font: 9,    weight: 500, tracking: 0,   minScale: 0.85, maxScale: Infinity,  searchZoom: 1,    sizeSteps: [[0.85, 9], [1, 9], [2, 10.5], [5, 11.5], [6, 12], [7, 12.5], [8, 13]] },
  monster:  { label: "Monster",  color: "#cf9868", font: 9,    weight: 500, tracking: 0,   minScale: 0.85, maxScale: Infinity,  searchZoom: 1,    sizeSteps: [[0.85, 9], [1, 9], [2, 10.5], [5, 11.5], [6, 12], [7, 12.5], [8, 13]] },
  detail:   { label: "Detail",   color: "#9aa2ab", font: 7.5,  weight: 500, tracking: 0,   minScale: 2,    maxScale: Infinity,  searchZoom: 2.5,  fadeBand: 2, sizeSteps: [[1, 7.5], [2, 8.5], [5, 9.5], [6, 10], [7, 10.5], [8, 11]] },
};
